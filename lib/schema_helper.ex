defmodule Skema.SchemaHelper do
  @moduledoc """
  This is only a specification to define a schema to use with `Skema.Params.cast` and `Skema.Contract.validate`
  ...
  **Alias**
  ...
  Skema.cast(%{email: "xx@yy.com"}, schema)
  ...
  **These validation are supported by `Skema.Validator`**
